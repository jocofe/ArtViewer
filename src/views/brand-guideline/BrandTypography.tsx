    ...
    <div className="guide-wrapper">
      <div className="guide__intro">
        ...
        <p className="guide__text">
          A Sans Serif font from the Neo-Grotesk family has been chosen to focus on readability given that it is an
          application that contains a lot of information and thus makes it easier for the user to read.
        </p>
      </div>
